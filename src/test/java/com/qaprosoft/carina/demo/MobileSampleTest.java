...
public class MobileSampleTest implements IAbstractTest, IMobileUtils {
    ...
    public void testWebView() {
        ...
        CarinaContactUsPageBase contactUsPage = webViewPageBase.goToContactUsPage();
...
//    @TestLabel(name = "test", value = {"mobile", "acceptance"})
//    public void testLearnMore() {
//        WelcomePageBase welcomePage = initPage(getDriver(), WelcomePageBase.class);
//        LoginPageBase loginPage = welcomePage.clickNextBtn();
//        CarinaDescriptionPageBase carinaDescriptionPage = loginPage.login();
//        WebViewPage webViewPage = new WebViewPage(getDriver());
//        webViewPage.clickLearnMoreBtn();
//        //Assert.assertTrue(webViewPage.getUiLoadedMarker().isClickable(), "Copy checkbox was not checked");
//        webViewPage.clickLearnMoreBtn();
//        //webViewPage.clickLearnMoreBtnMiCloud();

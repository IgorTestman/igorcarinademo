...
public class LoginPageUi extends LoginPageUiBase implements IMobileUtils, TimeConstants {
    ...
    public boolean isBackBtnPresent() {
        return backBtn.isElementPresent(THREE_SECONDS);
    }

    @Override
    public boolean isNameFieldPresent() {
        return nameInputField.isElementPresent(THREE_SECONDS);
    }
    ...
    public boolean isMaleRadioBtnPresent() {
        return maleRadioBtn.isElementPresent(THREE_SECONDS);
    }

    @Override
    public boolean isFemaleRadioBtnPresent() {
        return femaleRadioBtn.isElementPresent(THREE_SECONDS);
    }
    ...
    public boolean isPrivacyPoliceCheckboxPresent() {
        return privacyPolicyCheckbox.isElementPresent(THREE_SECONDS);
    }
    ...
    public boolean isPageOpened() {
        return waitUntil(ExpectedConditions.visibilityOf(loginBtn.getElement()), TWENTY_TIMEOUT);
    }
